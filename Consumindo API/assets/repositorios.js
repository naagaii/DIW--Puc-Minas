...
const buscarRepositoriosBtn = document.querySelector("#buscar-repositorios");

async function buscarRepositorios() {

    try {

        let idUsuario = usuarioGithubInput.value.trim();
        const repositorios = await repositorioService.obterRepositorios(idUsuario);
